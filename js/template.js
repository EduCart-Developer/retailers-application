...
Array.from(cart).forEach((e, idx) => {
    ...
    let totalBookPriceAfterDiscount = (priceAfterDiscount * e.quantity).toFixed(2);
    ...
    <tr style="font-size:12px;">
        ...
        <td class="total">${totalBookPriceAfterDiscount}</td>
    </tr>
    `;

    total += parseFloat(totalBookPriceAfterDiscount);
